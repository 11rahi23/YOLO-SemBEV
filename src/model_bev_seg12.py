...
class YOLOv8Neck(nn.Module):
    ...
    Input:  p3 (B, 256, 128, 128), p4 (B, 512, 64, 64), p5 (B, 1024, 32, 32)
    Output: Three detection-ready features at different scales
            - P3: (B, 256, 128, 128) for small objects
            - P4: (B, 256, 64, 64) for medium objects  
            - P5: (B, 256, 32, 32) for large objects
    """
    ...
    def forward(self, features):
        ...
        # Spatial sizes remain: P5=32×32, P4=64×464, P3=128×128
        ...
        # P4 -> P3: Upsample P4 (64x64 -> 128x128) and fuse with P3  
